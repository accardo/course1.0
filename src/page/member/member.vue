    ...
    export default {
        ...
        methods: {
        	...
        	getList:function(scroll){  //获取课程列表
                var _this = this
                var _listUrl = '/daydaycook/server/offline/reservationUser/offlineCourseList.do?type=2&reservationType=2&mobile=' + this.phone + '&pageSize=5&currentPage=' + this.currentPage
